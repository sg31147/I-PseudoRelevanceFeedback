...
def get_code_system2code_indices(
    ...
    code_system2code_indices = {} # รวมหมด
    #type diag { code : freq ....} / proc { code : freq ....}
    for codesystem, codes in data.code_system2code_counts.items(): #แยก เก็บ diag = {} proc = {}
...
def get_split2code_indices(
    ...
    #มีเก็บ train_val แยกต่างหาก แต่เทียบเท่า train เลย
...
def get_data_info(data: Data, vocab_size: int, pad_index: int) -> dict:
    #เพิ่ม มิติ vocab กับ pad_index เก็บไว้
    data_info = data.info
